...
!function (a) {
    var b = navigator.userAgent.toLowerCase(), c = function (a) {
        ...
        var b = !1, c = !1, n = [], o = function () {
            return function () {
                document.removeEventListener("DOMContentLoaded", o, !1), p()
            }
        }(), p = function () {
            if (!b) {
                b = !0;
                for (var a = 0; a < n.length; a++)n[a].call(document);
                n = []
            }
        }, q = function () {
            if (!c) {
                if (c = !0, "complete" === document.readyState)return setTimeout(p, 1);
                document.addEventListener("DOMContentLoaded", o, !1), a.addEventListener("load", p, !1)
            }
        }, r = function (a) {
            q(), b ? a.call(document, s) : n.push(function () {
                return a.call(this)
            })
        }, s = function (a) {
            return !a || a.nodeType ? a : "string" == typeof a ? (-1 != a.indexOf("#") && (a = a.substring(1)), document.getElementById(a)) : ("function" == typeof a && r(a), void 0)
        };
        s.apply = function (a, b) {
            ...
            version: "1.2.1", isEmpty: function (a, b) {
                return null === a || void 0 === a || s.isArray(a) && !a.length || (b ? !1 : "" === a)
            }, isArray: function (a) {
                ...
                for (var e = a.length, f = 0; e > f; f++)if (d && s.isArray(a[f]))s.each(a[f], b, c, d); else if (s.isFalse(b.call(c || a, a[f], f)))break
            }, eachAll: function (a, b, c) {
                s.each(a, b, c, !0)
            }, sor: function (a, b) {
                for (var c, d = a.length - 1, e = 0; d > e; e++)for (var f = d; f > e; f--)(b ? !b(a[f], a[f - 1]) : a[f] < a[f - 1]) && (c = a[f], a[f] = a[f - 1], a[f - 1] = c)
            }
        }), s.applyIf = function (a, b) {
            if (a && s.isObject(b))for (var c in b)s.isDefined(b[c]) && !s.isDefined(a[c]) && (a[c] = b[c]);
            return !b && a ? s.apply(a) : a
        }, s.merge = function (a, b, c, d) {
            if (a && s.isObject(b)) {
                for (var e in b)s.isDefined(b[e]) && (s.isObject(b[e]) ? s.isObject(a[e]) ? s.merge(a[e], b[e]) : a[e] = s.clone(b[e], !0) : a[e] = b[e]);
                return s.merge(a, c, d)
            }
            return a
        }, s.clone = function (a, b, c) {
            var d = {};
            if (s.isArray(a) && s.isObject(b))for (var e = 0; e < a.length; e++)d[a[e]] = c && s.isObject(b[a[e]]) ? s.clone(b[a[e]], c) : b[a[e]]; else if (s.isObject(a))for (var f in a)d[f] = b && s.isObject(a[f]) && !a[f].ICHARTJS_OBJECT ? s.clone(a[f], b) : a[f];
            return d
        }, s.override = function (a, b) {
            if (a && b) {
                var c = a.prototype;
                s.apply(c, b), s.isIE && b.hasOwnProperty("toString") && (c.toString = b.toString)
            }
        }, s.extend = function () {
            var a = function (a) {
            ...
            return function (c, d) {
                ...
                return g.prototype = h, e = f.prototype = new g, e.constructor = f, f.superclass = h, h.constructor == b && (h.constructor = c), f.override = function (a) {
                    ...
                    return h
                }, e.override = a, s.override(f, d), f.extend = function (a) {
                    return s.extend(f, a)
                }, f.plugin_ = {}, f.plugin = function (a, b) {
                    s.isString(a) && s.isFunction(b) && (f.plugin_[a] = b)
                }, f
            }
        }();
        var t = Math.sin, u = Math.cos, v = Math.atan, w = Math.sqrt, x = Math.abs, y = Math.PI, z = 2 * y, A = Math.ceil, B = Math.round, C = Math.floor, D = Math.max, E = Math.min, F = parseFloat, G = {}, H = {}, I = function (a, b) {
            if (0 == a)return a;
            var c = x(a), d = .1;
            if (c > 1) {
                for (; c > 1;)c /= 10, d = 10 * d;
            ...
            s.isArray(a) && (b = a[1], c = a[2], a = a[0]), a /= 255, b /= 255, c /= 255;
            var d = D(D(a, b), c), e = E(E(a, b), c), f = d - e;
            ...
            if (/^#(([a-fA-F0-9]{6,7})|([a-fA-F0-9]{3}))$/.exec(a))return J(a);
            throw new Error("invalid colors value '" + a + "'")
        }, N = function (a, b, c, d) {
            s.isArray(a) && (d = b, b = a[1], c = a[2], a = a[0]);
            var e, f, g, h = C(a / 60) % 6, i = a / 60 - h, j = c * (1 - b), k = c * (1 - b * i), l = c * (1 - b * (1 - i));
            switch (h) {
                case 0:
                    e = c, f = l, g = j;
                    break;
            ...
            return "rgb" + (d ? "a" : "") + "(" + B(255 * e) + "," + B(255 * f) + "," + B(255 * g) + (d ? "," + d + ")" : ")")
        }, O = .05, P = .14, Q = function (a, b) {
            return b = b || P, a > .5 ? b - (1 - a) / 10 : a > .1 ? b - .16 + a / 5 : a > b ? b : a / 2
        }, R = function (a, b, c, d) {
            if (!b)return b;
            b = K(M(b));
            var e = L(b);
            return d = 0 != d ? d || O : d, e[1] -= d, a ? (e[2] -= Q(e[2], c), e[1] = s.upTo(e[1], 1), e[2] = s.lowTo(e[2], 0)) : (e[2] += Q(1 - e[2], c), e[1] = s.lowTo(e[1], 0), e[2] = s.upTo(e[2], 1)), N(e, b[3])
        };
        return s.apply(s, {
            ...
            _Abstract: function (a, b) {
                if (!b[a])throw new Error("You must implements method '" + a + "' in " + b.type)
            },
            getAA: function (a) {
            ...
            plugin: function (a, b, c) {
                s.isFunction(a) && a.plugin(b, c)
            },
            parsePadding: function (a, b) {
                return a = a || 0, s.isNumber(a) ? new Array(a, a, a, a) : s.isArray(a) ? a : (b = b || 0, a = a.replace(/^\s+|\s+$/g, "").replace(/\s{2,}/g, /\s/).replace(/\s/g, ",").split(","), 1 == a.length ? a[0] = a[1] = a[2] = a[3] = F(a[0]) || b : 2 == a.length ? (a[0] = a[2] = F(a[0]) || b, a[1] = a[3] = F(a[1]) || b) : 3 == a.length ? (a[0] = F(a[0]) || b, a[1] = a[3] = F(a[1]) || b, a[2] = F(a[2]) || b) : (a[0] = F(a[0]) || b, a[1] = F(a[1]) || b, a[2] = F(a[2]) || b, a[3] = F(a[3]) || b), a)
            },
            distanceP2P: function (a, b, c, d) {
                return w((c - a) * (c - a) + (d - b) * (d - b))
            },
            atan2Radian: function (a, b, c, d) {
                if (a == c)return d > b ? y / 2 : 3 * y / 2;
                if (b == d)return c > a ? 0 : y;
                var e = s.quadrant(a, b, c, d), f = v(x((b - d) / (a - c)));
                return e ? (3 == e ? z : y) + (2 == e ? f : -f) : f
            },
            ...
            visible: function (a, b, c) {
                if (a >= b)return [];
                var d = s.quadrantd(a), e = s.quadrantd(b);
                if ((2 == d || 3 == d) && (2 == e || 3 == e) && y > b - a)return [];
                if (a = s.toPI2(a), b = s.toPI2(b), a >= b && (b += z), a > y)a = z; else {
                    if (b > z)return [{s: a, e: y, f: c}, {s: z, e: b, f: c}];
                    b > y && (b = y)
                }
                return {s: a, e: b, f: c}
            },
            ...
            vectorP2P: function (a, b, c) {
                return c || (b = s.angle2Radian(b), a = s.angle2Radian(a)), b = t(b), {x: b * t(a), y: b * u(a)}
            },
            uid: function () {
                var a = function () {
                    return C(65536 * (1 + Math.random())).toString(16).substring(1)
                };
                return function (b) {
            ...
            register: function (a) {
                if (s.isString(a))H[a.toLowerCase()] = a; else {
                    var b = a.get("id");
                    if (b && "" != b || (b = a.push("id", s.uid(a.type))), G[b])throw new Error("Exist Reduplicate id :" + b);
                    a.id = b, G[b] = a
                }
            },
            create: function (a) {
                if (!a.type || !H[a.type])throw new Error("TypeNotFoundException[" + a.type + "]");
                return new s[H[a.type]](a)
            },
            remove: function (a) {
                var b = G[a];
                b.destroy(), delete G[a]
            },
            get: function (a) {
                return G[a]
            },
            ...
            parsePercent: function (a, b) {
                return s.isString(a) && (a = a.match(/(.*)%/), a && (a = b ? C(F(a[1]) * b / 100) : a[1] / 100)), !a || 0 >= a || a > b ? b : a
            },
            parseFloat: function (a, b) {
                if (!s.isNumber(a) && (a = F(a), !s.isNumber(a)))throw new Error("[" + b + "]is not a valid number.");
                return a
            },
            ceil: function (a) {
                return I(a, 1)
            ...
            fixPixel: function (a) {
                return s.isNumber(a) ? a : F(a.replace("px", "")) || 0
            },
            toPixel: function (a) {
    ...
    a.Element = function (b) {
        var c = this._();
        c.type = "element", c.ICHARTJS_OBJECT = !0, a._Abstract("configure", c), a._Abstract("afterConfiguration", c), c.options = {}, c.set({
            border: {
                enable: !1,
                color: "#BCBCBC",
                style: "solid",
        ...
        configure: function (b) {
            this.type = "html", this.T = b, a._Abstract("beforeshow", this), this.set({
                animation: !0,
                default_action: !0,
                width: 0,
                height: 0,
            ...
            this.dom && this.wrap.removeChild(this.dom), this.dom = null
        ...
        configure: function () {
            this.type = "painter", this.dimension = a._2D, a._Abstract("commonDraw", this), a._Abstract("initialize", this), this.set({
                strokeStyle: "gray",
                padding: 10,
                color: "black",
                offsetx: 0,
        ...
        configure: function (b) {
            ...
            }), this.atomic = !1, this.proxy = !1, this._chart = !1, this.inject(b)
        }, initialize: function () {
        ...
        configure: function () {
            ...
            return b.x > this.x && b.x < c.x + c.width && b.y > c.y && b.y < c.y + c.height && a.each(c.data, function (a, f) {
                return b.x > a.x && b.x < a.x + a.width_ + c.get("signwidth") && b.y > a.y - e / 2 && b.y < a.y + e / 2 ? (d = {
                    valid: !0,
                    index: f,
                    target: a
                }, !1) : void 0
        ...
        var c = Math.PI, d = c / 90, e = d / 2, f = Math.ceil, g = Math.floor, h = 2 * c, i = Math.max, j = Math.min, k = Math.sin, l = Math.cos, m = function (a, b) {
            ...
            if (c.data = b, "simple" == c.dataType)c.total = 0, a.each(b, function (b) {
                if (b.background_color = b.color, f = b.value || 0, a.isArray(f)) {
                    var k = 0;
                    g = f.length > g ? f.length : g;
                    for (var l = 0; l < f.length; l++)null != f[l] && (f[l] = o(f[l]), k += f[l], h || (d = e = f[l], h = !0), d = i(f[l], d), e = j(f[l], e));
                    b.total = k
                ...
                c.columns = [];
                for (var r = 0; p > r; r++)l = [], m = 0, a.each(b, function (c, g) {
                    f = c.value[r], (f || 0 == f) && (c.value[r] = f = o(f), m += f, q ? n = b[g].color : (n = c.color, h || (d = e = f, h = !0), d = i(f, d), e = j(f, e)), l.push(a.applyIf({
                        name: c.name,
                        value: c.value[r],
                        background_color: n,
                        color: n
        ...
        b.prototype = {
            getContext: function () {
                ...
                if (b = b.toString(), !b || !b.length)return this;
                ...
                for (var a in q)this.canvas.removeEventListener(a, q[a], !1);
                q = {}
            }, addEvent: function (b, c) {
                q[b] = c, a.Event.addEvent(this.canvas, b, c, !1)
            }
        }, a.taylor = {
            light: function (a, b) {
            ...
            configure: function () {
                a.Chart.superclass.configure.apply(this, arguments), this.type = "chart", this.dataType = "simple", this.set({
                    ...
                    coordinate: {xAxis: {position: "bottom"}, yAxis: {position: "left"}},
                    animation: !1,
                    doAnimation: null,
                    ...
                    legend: {enable: !1},
                    tip: {enable: !1}
                }), this.registerEvent("beforeAnimation", "afterAnimation", "resize", "animating"), this.T = null, this.Rendered = !1, this.Combination = !1, this.Animationed = !1, this.show = !1, this.data = [], this.plugins = [], this.components = [], this.oneways = [], this.total = 0, this._chart = !0
            }, toDataURL: function (a) {
                ...
                return b.show = !1, b.redraw || (a.Assert.isTrue(b.Rendered, b.type + " has not rendered"), b.doSort()), b.redraw = !0, !b.Animationed && b.get("animation") ? (b.runAnimation(b), void 0) : (b.segmentRect(), a.eachAll(b.components, function (a) {
                    a.draw(c)
                ...
                if (!b) {
                    b = b || this, b.segmentRect();
                    for (var c in b.events)b.events[c] = [];
                    b.T.unbound()
                }
                a.eachAll(b.components, function (a) {
                ...
                b.stopEvent = !1, b.A_draw = h && b.processAnimation, a.register(b), h || a.each(k, function (c) {
                    ...
                    return a.eachAll(e, function (a) {
                        if (a._chart) {
                            if (a.fireEvent(a, k[0], [a, c]))return g.click = !0, !1
                        } else {
                            var b = a.isMouseOver(c);
                            if (b.valid)return g.click = !0, a.fireEvent(a, "click", [a, c, b]), !c.stopPropagation
                        }
                    ...
                    return c = d = !1, a.eachAll(e, function (a) {
                        if (!a._chart) {
                            ...
                            if (d.valid) {
                                if (c = c || a.atomic, b.mouseover || (b.mouseover = !0, a.fireEvent(a, "mouseover", [a, f, d])), a.fireEvent(a, "mousemove", [a, f, d]), d.stop)return !1
                            } else b.mouseover && (b.mouseover = !1, a.fireEvent(a, "mouseout", [a, f, d]));
                            return !f.stopPropagation
                        }
                        return a.fireEvent(a, k[1], [a, f]) ? (c = !0, !1) : void 0
                    }), g.mouseover ? (f.event.preventDefault(), c || (g.mouseover = !1, b.fireEvent(b, "mouseout", [b, f])), g.mouseover) : (c && (g.mouseover = c, b.fireEvent(b, "mouseover", [b, f])), void 0)
        ...
        configure: function () {
            ...
            a.get("ignored") || (a.label && !a.get("mini_label") && a.label.draw(), Math.abs(a.get("endAngle") - a.get("startAngle")) > 1e-5 && a.drawSector(), a.label && a.get("mini_label") && a.label.draw())
        ...
        configure: function () {
            ...
            a.label && a.get("actived") && a.label.draw()
        }, doDraw: function (a) {
            a.get("actived") && a.drawRectangle()
        }, doConfig: function () {
        ...
        configure: function () {
            ...
            return {valid: b.get("actived") && a.x > b.x && a.x < b.x + b.width && a.y < b.y + b.height && a.y > b.y}
        }, tipInvoke: function () {
            var a = this._();
            return function (b, c) {
        ...
        configure: function () {
            ...
            return {valid: b.get("actived") && a.x > b.x && a.x < b.x + b.get(b.W) && a.y < b.y + b.get(b.H) && a.y > b.y}
        }, tipInvoke: function () {
            var a = this._();
            return function (b, c) {
        ...
        configure: function () {
            ...
            a = (a || 0) % this.rectangles.length;
            var c = this.rectangles[a], d = this.labels[a];
            "undefined" == typeof b && (b = !d.get("actived")), c.push("actived", b), d.push("actived", b), this._draw()
            ...
            a.doActing(a, b, d, c)
        }, rect: function (b, c, d, e, f, g, h, i) {
            var j = c.value;
            b.get("percent") && (j = 100 * j / c.total);
            var k = i.getMark(j, h) * g;
            return b.doParse(b, c, d, {
                id: d,
                originx: e,
                originy: f - (k > 0 ? k : 0),
                height: Math.abs(k)
            }), b.rectangles.push(new a[b.sub](b.get("sub_option"), b)), k
        }, engine: function (a) {
            if (!a.isE()) {
                var b = a.get("column_width_"), c = a.get("column_space"), d = a.coo.getScaleObj(a.get("scaleAlign")), e = d.getScale(d), f = a.coo.valid_height, g = b / 2, h = b * (a.get("group_fator") || 0), i = "complex" != a.dataType ? b + c : a.data.length * b + c + (a.is3D() ? (a.data.length - 1) * h : 0), j = a.coo.get("y_end"), k = j - e.basic * f - (a.is3D() ? a.get("zHeight") * (a.get("bottom_scale") - 1) / 2 * a.get("yAngle_") : 0), l = c + a.coo.get("x_start");
                j = j + a.get("text_space") + a.coo.get("axis.width")[2], a.doEngine(a, b, c, e, d, f, g, h, i, l, k, j)
            }
        }, doConfig: function () {
            a.Column.superclass.doConfig.call(this);
            var b = this._(), c = "column_width", d = "z_index";
            b.sub = b.is3D() ? "Rectangle3D" : "Rectangle2D", b.rectangles.length = 0, b.labels.length = 0, b.rectangles.zIndex = b.get(d), b.labels.zIndex = b.get(d) + 1, b.Combination || b.pushIf("coordinate.scale", [a.apply(b.get("coordinate.yAxis"), {
                maxValue: b.get("maxValue"),
                minValue: b.get("minValue")
            })]), b.coo = a.Coordinate.coordinate_.call(b, function (d) {
        ...
        }, doEngine: function (b, c, d, e, f, g, h, i, j, k, l, m) {
            a.each(b.data, function (a, c) {
                b.rect(b, a, c, k + c * j, l, g, e, f), b.doLabel(b, c, a.name, k + j * c + h, m)
            }, b)
        }, doConfig: function () {
        ...
        configure: function () {
            ...
            a.each(b.columns, function (h, n) {
                a.each(h.item, function (a, d) {
                    b.rect(b, a, n + "_" + d, k + d * (c + i) + n * j, l, g, e, f)
                }, b), b.doLabel(b, n, h.name, k - .5 * d + (n + .5) * j, m)
            }, b)
        }, doConfig: function () {
        ...
        configure: function () {
            ...
            var n;
            a.each(b.columns, function (c, h) {
                n = 0, a.each(c.item, function (a, d) {
                    a.total = c.total, n += b.rect(b, a, h + "_" + d, k + h * j, l - n, g, e, f)
                }, b), b.doLabel(b, h, c.name, k - .5 * d + (h + .5) * j, m)
            }, b)
        }, doConfig: function () {
        ...
        configure: function () {
            ...
            return b.doParse(b, c, d, {
                id: d,
                originx: e - (k > 0 ? 0 : Math.abs(k)),
                originy: f,
                width: Math.abs(k)
            }), b.rectangles.push(new a.Rectangle2D(b.get("sub_option"), b)), k
        }, engine: function (a) {
            if (!a.isE()) {
                var b = a.get("_bar_height"), c = a.get("bar_space"), d = a.coo.getScaleObj(a.get("scaleAlign")), e = d.getScale(d), f = a.coo.valid_width, g = b / 2, h = "complex" != a.dataType ? b + c : a.data.length * b + c, i = a.coo.get("x_start") + e.basic * f, j = a.coo.get(a.X) - a.get("text_space") - a.coo.get("axis.width")[3], k = a.coo.get("y_start") + c;
                a.doEngine(a, b, c, e, d, f, g, h, i, k, j)
            }
        }, doAnimation: function (b, c, d) {
            a.each(d.labels, function (a) {
                a.draw()
            ...
            b.rectangles.length = 0, b.labels.length = 0, b.rectangles.zIndex = b.get(c), b.labels.zIndex = b.get(c) + 1, b.Combination || b.pushIf("coordinate.scale", [a.apply(b.get("coordinate.xAxis"), {
                maxValue: b.get("maxValue"),
                minValue: b.get("minValue")
        ...
        configure: function () {
            ...
            a.each(b.data, function (a, c) {
                b.rect(b, a, c, j, k + c * i, g, e, f), b.doLabel(b, c, a.name, l, k + c * i + h)
            }, b)
        }, doConfig: function () {
            a.Bar2D.superclass.doConfig.call(this), this.engine(this)
        }
    }), a.register("Bar2D"), a.BarStacked2D = a.extend(a.Bar, {
        configure: function () {
            ...
            var m;
            a.each(b.columns, function (c, h) {
                m = 0, a.each(c.item, function (a, d) {
                    a.total = c.total, m += b.rect(b, a, h + "_" + d, j + m, k + h * i, g, e, f)
                }, b), b.doLabel(b, h, c.name, l, k - .5 * d + (h + .5) * i)
            }, b)
        }, doConfig: function () {
            a.BarStacked2D.superclass.doConfig.call(this), this.push("sub_option.valueAlign", this.C), this.engine(this)
        }
    }), a.register("BarStacked2D"), a.BarMulti2D = a.extend(a.Bar, {
        configure: function () {
            a.BarMulti2D.superclass.configure.call(this), this.type = "barmulti2d", this.dataType = "complex", this.set({labels: []})
        }, doEngine: function (b, c, d, e, f, g, h, i, j, k, l) {
            a.each(b.columns, function (h, m) {
                a.each(h.item, function (a, d) {
                    b.rect(b, a, m + "_" + d, j, k + d * c + m * i, g, e, f)
                }, b), b.doLabel(b, m, h.name, l, k - .5 * d + (m + .5) * i)
            }, b)
        }, doConfig: function () {
            a.BarMulti2D.superclass.doConfig.call(this), this.engine(this)
        }
    }), a.register("BarMulti2D"), a.Tip = a.extend(a.Html, {
        configure: function () {
            ...
            a.T.on("mouseover", function (b, c, d) {
                ...
                a.T.variable.event.mouseover && setTimeout(function () {
                    a.dom && a.T.variable.event.mouseover && a.follow(c, d, a)
                }, a.get("delay"))
            })
        }, initialize: function () {
    ...
    }), a.register("Donut2D"), a.Scale = a.extend(a.Component, {
        configure: function () {
            ...
            return {valid: !1}
        }, getMark: function (a, b) {
            for (var c = b.values, d = 1; d < c.length; d++)if (a <= c[d])return ((a - c[d - 1]) / (c[d] - c[d - 1]) + (d - 1)) / (c.length - 1) - b.basic;
            throw new Error("InValidMark")
        }, getScale: function (b) {
            var c = [b.get("start_scale"), b.get("end_scale")];
            return c[2] = a.inRangeClosed(b.get("start_scale"), b.get("end_scale"), 0), {
                basic: c[2] ? b.getMark(0, {
                    values: b.values,
                    basic: 0
                }) : 0, values: b.values
            }
            ...
            var b, c = this._(), d = Math.abs, e = c.get("labels"), f = e.length, g = c.get("min_scale"), h = c.get("max_scale"), i = c.get("scale_space"), j = c.get("end_scale"), k = c.get("start_scale"), l = c.get("step");
            if (c.items = [], c.labels = [], c.values = [], f && ((e[0] < k || e[0] < g) && (k = e[0]), (e[f - 1] > j || e[f - 1] > h) && (j = e[f - 1])), k > g && (k = c.push("start_scale", a.floor(g))), (!a.isNumber(j) || h > j) && (j = a.ceil(h), j = j || k ? j : 1, c.push("end_scale", j)), 0 == f) {
                b = 5;
                var m = d(j - k);
                if (i && d(i) < d(m))b = d(Math.ceil(m / i)); else {
                    for (var n = m.toString(), o = n.indexOf(".") + 1, p = 10, q = (o > 0 ? /^0\.0*([1-9])$/ : /^([1-9])0*$/).exec(n); o > 0;)o--, p *= 10;
                    q && q[1] && (b = parseInt(q[1])), b = 1 == b ? 5 : b, b = 8 == b || 2 == b ? 4 : b, b = 9 == b ? 3 : b, i = c.push("scale", m * p / b / p)
                }
                parseInt(i) != i && 0 == c.get("decimalsnum") && c.push("decimalsnum", (i + "").substring((i + "").indexOf(".") + 1).length)
            } else b = f - 1, e[0] > g && (e[0] = k), e[b] < h && (e[b] = j);
            c.push("end_scale", j), c.push("distanceOne", c.get("valid_distance") / (b ? b : 1));
            var r, s, t, u = 0, v = 0, w = 0, x = 0, y = 0, z = 0, A = c.get("scale_width"), B = A / 2, C = c.get("scaleAlign"), D = c.get("position"), E = c.get("text_space"), F = "", G = c.get("coo").get("axis.width");
            c.push("which", c.get("which").toLowerCase()), c.isH = "h" == c.get("which"), c.isH ? (C == c.O ? x = -A : C == c.C ? (x = -B, v = B) : v = A, D == c.O ? (z = -E - G[0], F = c.B) : (z = E + G[2], F = c.O), D = c.C) : (C == c.L ? w = -A : C == c.C ? (w = -B, u = B) : u = A, F = "middle", D == c.R ? (D = c.L, y = E + G[1]) : (D = c.R, y = -E - G[3]));
            for (var H = 0; b >= H; H++)if (0 == H % l) {
                r = f ? "undefined" == typeof e[H] ? H : e[H] : (i * H + k).toFixed(c.get("decimalsnum")), s = c.isH ? c.get("valid_x") + H * c.get("distanceOne") : c.x, t = c.isH ? c.y : c.get("valid_y") + c.get("valid_distance") - H * c.get("distanceOne");
                try {
                    c.values.push(a.parseFloat(r))
                } catch (I) {
                    c.values.push(r)
                }
                c.items.push({
                    ...
                    x1: s + u,
                    y1: t + v
                }), c.get("label") && c.labels.push(new a.Text(a.applyIf(a.apply(c.get("label"), a.merge({
                    text: r,
                    x: s,
                    y: t,
                    originx: s + y,
                    originy: t + z
                }, c.fireEvent(c, "parseText", [r, s + y, t + z, H, b == H]))), {textAlign: D, textBaseline: F}), c))
            }
        }
    }), a.Coordinate = {
        coordinate_: function (b) {
            var c = this._(), d = c.get("coordinate"), e = c.get("scaleAlign");
            if (d.ICHARTJS_OBJECT)return c.x = c.push(c.X, d.x), c.y = c.push(c.Y, d.y), c.ILLUSIVE_COO = !0, d.refresh(c.get("minValue"), c.get("maxValue"), e), b && b(d.get("_valid_width"), d.get("_valid_height")), d;
            ...
            c.originXY(c, [c.get("l_originx"), c.get("r_originx") - i, c.get("centerx") - i / 2], [c.get("centery") - j / 2]), c.set({
                coordinate: {
                    originx: c.x,
                    originy: c.y,
                    id: "coordinate"
            ...
            var m = "stacked" == c.dataType && c.get("percent");
            return a.isObject(h) && (h = [h]), a.each(h, function (b) {
                m && c.get("percent") && b.position == e ? a.apply(b, {
                    percent: !0,
                    start_scale: 0,
                    end_scale: 100,
                    scale_space: 10,
                ...
                }) : (b.min_scale = b.max_scale = void 0, (!b.start_scale || b.start_scale > c.get("minValue")) && (b.min_scale = c.get("minValue")), (!b.end_scale || b.end_scale < c.get("maxValue")) && (b.max_scale = c.get("maxValue")))
            }), c.is3D() && c.set({
                coordinate: {
        ...
        configure: function () {
            a.Coordinate2D.superclass.configure.apply(this, arguments), this.type = "coordinate2d", this.set({
                ...
                crosshair: {enable: !1},
                z_index: -1,
                axis: {enable: !0, color: "#666666", width: [0, 0, 1, 1]}
            }), this.scale = [], this.gridlines = []
        }, refresh: function (b, c, d) {
            a.each(this.scale, function (a) {
                if (a.get("position") == d) {
                    var e;
                    return (!a.get("force_scale") || a.get("end_scale") < c) && (a.push("max_scale", a.push("end_scale", c)), e = !0), (!a.get("force_scale") || a.get("start_scale") > b) && (a.push("min_scale", a.push("start_scale", b)), e = !0), e && a.doConfig(), !1
                }
            })
        }, getScaleObj: function (a, b) {
            for (var c = this._(), d = 0; d < c.scale.length; d++)if (c.scale[d].get("position") == a)return c.scale[d];
            if (!b)return a = a == c.L ? c.R : a == c.R ? c.L : a == c.O ? c.B : c.O, c.getScaleObj(a, !0);
            ...
            a.Coordinate2D.superclass.destroy.call(this), this.crosshair && this.crosshair.destroy()
            ...
            b.doCrosshair(b);
            var d, e = !(!b.get("gridlinesVisible") || !b.get("grids")), f = e && !!b.get("grids.horizontal"), g = e && !!b.get("grids.vertical"), h = b.height, i = b.width, j = b.valid_width, k = b.valid_height, l = b.get("gridlinesVisible") && b.get("scale2grid") && !(f && g), m = b.push("x_start", b.x + (i - j) / 2), n = b.push("y_start", b.y + (h - k) / 2), o = b.get("axis.width"), p = b.get("scale");
            b.push("x_end", b.x + (i + j) / 2), b.push("y_end", b.y + (h + k) / 2), p = a.isArray(p) ? p : b.push("scale", a.isObject(p) ? [p] : []), a.each(p, function (c) {
            ...
            var q = b.push("ignoreOverlap", b.get("ignoreOverlap") && b.get("axis.enable") || b.get("ignoreEdge"));
            if (q)if (b.get("ignoreEdge"))var r = function (a, c, d) {
                return "v" == a ? d == b.y || d == b.y + h : c == b.x || c == b.x + a
            }; else var r = function (a, c, d) {
            ...
            }, t = a.applyIf(b.get("gridHStyle"), s), u = a.applyIf(b.get("gridVStyle"), s);
            if (l) {
                var v, w, x;
                a.each(b.scale, function (c) {
                    x = c.get("position"), a.isFalse(c.get("scale2grid")) || f && "v" == c.get("which") || g && "h" == c.get("which") || (v = w = 0, x == b.O ? w = h : x == b.R ? v = -i : x == b.B ? w = -h : v = i, a.each(c.items, function (d) {
                        q && b.gridlines.push(a.applyIf({
                            overlap: r.call(b, c.get("which"), d.x, d.y),
                            x1: d.x,
                            y1: d.y,
                            x2: d.x + v,
                            y2: d.y + w
            ...
            if (g) {
                var y = b.get("grids.vertical"), z = i / y.value, A = y.value;
                "given_value" == y.way && (A = z, z = y.value, z = z > i ? i : z);
                for (var B = 0; A >= B; B++)q && b.gridlines.push(a.applyIf({
                    overlap: r.call(b, "h", b.x + B * z, b.y),
                    x1: b.x + B * z,
                    y1: b.y,
                    x2: b.x + B * z,
                    y2: b.y + h,
            ...
            if (f) {
                var C = b.get("grids.horizontal"), z = h / C.value, A = C.value;
                "given_value" == C.way && (A = z, z = C.value, z = z > h ? h : z);
                for (var B = 0; A >= B; B++)q && b.gridlines.push(a.applyIf({
                    overlap: r.call(b, "v", b.x, b.y + B * z),
                    x1: b.x,
                    y1: b.y + B * z,
                    x2: b.x + i,
                    y2: b.y + B * z,
        ...
        configure: function () {
            a.CrossHair.superclass.configure.apply(this, arguments), this.type = "crosshair", this.set({
                ...
                hcross: !0,
                vcross: !0,
                point: {enable: !0, color: null, size: 12},
                invokeOffset: null,
                line_width: 1,
                line_color: "#1A1A1A",
                delay: 200
        ...
        configure: function () {
            ...
            b.get("actived") && (b.drawSegment(), b.get("label") && a.each(b.labels, function (a) {
                a.draw()
            }))
        }, isEventValid: function () {
        }, tipInvoke: function () {
            ...
            var c, d, e = b.get("points"), f = b.get("intersection"), g = !!b.get("label"), h = [], i = b.get("smooth"), j = b.get("smoothing") || 1.5, k = b.get("f_color"), l = b.get("brushsize"), m = b.get("point_size"), n = b.get("color_with_point");
            if (f) {
                var o = b.getPlugin("sign"), p = k, q = b.get("hollow_color");
                b.sign_plugin = a.isFunction(o), b.sign_plugin_fn = o, b.get("hollow_inside") && (p = q, q = k)
            }
            a.each(e, function (e) {
                e.x_ = e.x, e.y_ = e.y, e.color = e.color || k, d = !e.ignored && !e.direct, d && g && (b.push("label.originx", e.x), b.push("label.originy", e.y - m / 2 - 1), b.push("label.text", b.fireString(b, "parseText", [b, e.value], e.value)), a.applyIf(b.get("label"), {
                    textBaseline: "bottom",
                    color: b.get("f_color")
                }), b.labels.push(new a.Text(b.get("label"), b))), (e.ignored || n && c && c != e.color) && h.length ? (e.ignored || h.push(e), b.lines.push([h, l, c, i, j]), b.PP(b, h, h[0].x, b.y, h[h.length - 1].x, b.y), h = e.ignored ? [] : [e]) : d && h.push(e), c = e.color, f && d && b.intersections.push(b.sign_plugin ? [b.T, b.get("sign"), e, m, e.color || p, e.hollow_color || q] : b.get("hollow") ? [e, m / 2 - l + 1, e.color || p, l + 1, e.hollow_color || q] : [e, m / 2, e.color || p])
            }), h.length && (b.lines.push([h, l, c || k, i, j]), b.PP(b, h, h[0].x, b.y, h[h.length - 1].x, b.y))
        }, doConfig: function () {
            ...
            b.isEventValid = function (c) {
                if (!b.get("actived") || j && !j.isEventValid(c, j).valid)return {valid: !1};
        ...
        configure: function () {
            a.Line.superclass.configure.call(this), this.type = "line", this.set({
                ...
                legend: {sign: "bar"},
                label: {}
            }), this.registerEvent("parsePoint"), this.lines = [], this.components.push(this.lines), this.on("resize", function () {
                this.push("point_space", 0)
            })
        }, load: function (b, c) {
            for (var d = this.get("coordinate.scale"), e = 0; c && e < d.length; e++)d[e].position == this.get("labelAlign") && (d[e].labels = c);
            this.push("point_space", 0), a.Line.superclass.load.call(this, b)
        }, toggle: function (a, b) {
            var c = this.lines[(a || 0) % this.lines.length];
            "undefined" == typeof b && (b = !c.get("actived")), c.push("actived", b), this._draw()
        }, getCoordinate: function () {
            return this.coo
        }, doConfig: function () {
            ...
            if (b.get("crosshair.enable") && (b.pushIf("crosshair.hcross", c), b.pushIf("crosshair.invokeOffset", function (a) {
                    ...
                    return c.valid ? c : d
                })), b.Combination || (b.push("coordinate.crosshair", b.get("crosshair")), b.pushIf("coordinate.scale", [a.apply(b.get("coordinate.yAxis"), {
                    maxValue: b.get("maxValue"),
                    minValue: b.get("minValue")
                }), a.apply(b.get("coordinate.xAxis"), {end_scale: b.get("maxItemSize")})])), b.coo = a.Coordinate.coordinate_.call(b), b.Combination && (b.coo.push("crosshair", b.get("crosshair")), b.coo.doCrosshair(b.coo)), !b.isE()) {
        ...
        configure: function () {
            ...
            var b = this._();
            if (!b.isE()) {
                var c, d, e, f, g, h, i, j = b.coo.valid_height, k = b.get("point_space"), l = b.get("sub_option.originx"), m = b.get("nullToDirect");
                b.push("sub_option.tip.showType", "follow"), b.push("sub_option.coordinate", b.coo), b.push("sub_option.tipInvokeHeap", b.tipInvokeHeap), b.push("sub_option.point_space", k), a.each(b.data, function (n) {
                    c = b.coo.getScaleObj(n.scaleAlign || b.get("scaleAlign")), d = c.getScale(c), h = b.get("sub_option.originy") - d.basic * j, e = [], a.each(n.value, function (o, p) {
                        null != o ? (f = k * p, g = c.getMark(o, d) * j, i = {
                            x: l + f,
                            y: h - g,
                            value: o,
                            text: n.name + " " + o
                        }, a.merge(i, b.fireEvent(b, "parsePoint", [n, o, f, g, p, d])), e.push(i)) : e.push({
                            ignored: !m,
                            direct: m
                        })
                    }, b), a.merge(b.get("sub_option"), n), b.push("sub_option.points", e), b.push("sub_option.brushsize", n.linewidth || n.line_width), b.lines.push(new a.LineSegment(b.get("sub_option"), b))
                }, this)
            }
        }
